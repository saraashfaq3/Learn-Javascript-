...
const name = "sara";
const repoCount = 50;
console.log(name + repoCount + "value"); //This syntax is outdated don't use it. //sara50value

//Use this string Interpolation-> is k andar methods bhi sath hi perform k sakty hain
// e.g; ${name.ToUperCase}
console.log(`Hello my name is ${name} and my repo count is ${repoCount}`);  //Hello my name is sara and my repo count is 50
...
console.log(gameName); //[String: 'sara-ashfaq-3']
//Methods
console.log(gameName[0]); //Keys access karny k tarika  //s
...
console.log(gameName.toUpperCase()); //SARA-ASHFAQ-3

//charAt
console.log(gameName.charAt(3));  //kis index/position per konsa character ha //a

//indexOf
console.log(gameName.indexOf("r"));  //character kis position/index per ha //2

//substring
const newString=gameName.substring(0,5); //0 se le kar 4 tak ki values aye gi 5 wali include nahi hogi
console.log(newString);  //sara-

//slice
const anotherSring=gameName.slice(-12,4)
console.log(anotherSring); //ara
...
//split() method ka use string ko multiple parts mein todne ke liye hota hai. 
// Yeh array return karta hai.
console.log(gameName.split('-')); //[ 'sara', 'ashfaq', '3' ]
...
let str1="hello";
let str2="world";
console.log(str1.concat(" ",str2," ","sara"));  //hello world sara
